...
/Library/Java/JavaVirtualMachines/1.6.0_65-b14-462.jdk/Contents/Home/bin/javac GimbalUnityInterface.java -bootclasspath $ANDROID_SDK_ROOT/platforms/android-21/android.jar -d .
